   ...
   <div class="breadcrumb">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="card-title mb-3">Nuevo Proyecto</div>
                        <form class="needs-validation" novalidate method="POST" action="{{ url('/projects/store') }}">
                            {{ csrf_field() }}
                                <div class="row">
                                    <div class="col-md-6 form-group mb-3">
                                        <label for="firstName">Nombre</label>
                                        <input type="text" class="form-control form-control-rounded" 
                                            name="name" id="name" placeholder="Nombre de proyecto" required>
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            <input id="date_begin" name="date_begin" class="form-control form-control-rounded" placeholder="yyyy-mm-dd" name="dp" >
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            <input id="date_end" name="date_end" class="form-control form-control-rounded" placeholder="yyyy-mm-dd">
                                            <div class="input-group-append">
                                                <button class="btn btn-secondary btn-rounded"  type="button">
                                                    <i class="icon-regular i-Calendar-4"></i>
                                                </button>

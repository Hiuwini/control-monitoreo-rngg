...
$(document).ready(function () {
    ...
    if (echartElemPie) {
        ...
        echartPie.setOption({
            ...
            series: [{
                ...
                radius: '60%',
                center: ['50%', '50%'],
                data: [{ value: 535, name: 'Masculino' }, { value: 310, name: 'Brazil' }, { value: 234, name: 'France' }, { value: 155, name: 'BD' }, { value: 130, name: 'UK' }, { value: 348, name: 'India' }],
                itemStyle: {
                    emphasis: {
                        shadowBlur: 10,
                        shadowOffsetX: 0,
    ...
    //Grafica de genenero en forma de pie
    var echartElemPie = document.getElementById('GraficaPieGenero');
    if (echartElemPie) {
        var GraficaPieGenero = echarts.init(echartElemPie);
        GraficaPieGenero.setOption({
            color: ['#62549c', '#7566b5', '#7d6cbb', '#8877bd', '#9181bd', '#6957af'],
            tooltip: {
                show: true,
                backgroundColor: 'rgba(0, 0, 0, .8)'

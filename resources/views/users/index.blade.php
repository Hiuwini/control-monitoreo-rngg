                            ...
                            <form>
                                <div class="row">
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-rounded" id="firstName" placeholder="Ingrese nombres">
                                    </div>
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <input type="text" class="form-control form-control-rounded" id="username" placeholder="Ingrese nombre de usuario">
                                    </div>
                                    
                                    <div class="col-md-6 form-group mb-3">
                                        <label for="email">Correo Electrónico</label>
                                        <input type="email" class="form-control form-control-rounded" id="email"  placeholder="Ingrese correo electrónico">
                                    </div>

                                    <div class="col-md-6 form-group mb-3">
                                        <label for="phone1">Teléfono / Celular</label>
                                        <input class="form-control form-control-rounded" id="phone1" placeholder="Ingrese teléfono o celular">
                                    </div>
